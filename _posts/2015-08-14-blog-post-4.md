...
The IG-LLM model is a model built upon the concept of neural scene de-rendering, with an instruction-tuned variant of LLaMA-1 7B in conjunction with a frozen CLIP vision encoder, used as the visual tokenizer. The layers of IG-LLM are as following:
